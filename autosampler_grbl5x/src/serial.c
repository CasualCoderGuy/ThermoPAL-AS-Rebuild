...
ISR(SERIAL_RX)
{
  ...
  switch (data) {
    ...
    case CMD_FC_VALVE_COLLECT:   fc_valve_collect(); break;
    case CMD_FC_VALVE_WASTE:     fc_valve_waste(); break;
    case CMD_JOG_CANCEL:
    ...
    default :
      if (data > 0x7F) { // Real-time control characters are extended ACSII only.
        switch(data) {
          ...
          #endif
          case CMD_SERIAL_WELCOME: send_state(); send_pos(); send_aux(); report_init_message(); break;
