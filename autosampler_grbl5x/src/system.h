...
#define STATE_AS_PARK       bit(0)
#define STATE_AS_TEACH      bit(1)
#define STATE_AS_COLLECT    bit(2)
#define STATE_AS_JOB        bit(3)
...
#define N_CONTROL_PIN 7
#define CONTROL_PIN_INDEX_SAFETY_DOOR   bit(0)
#define CONTROL_PIN_INDEX_RESET         bit(1)
#define CONTROL_PIN_INDEX_FEED_HOLD     bit(2)
#define CONTROL_PIN_INDEX_CYCLE_START   bit(3)
#define LC_EVT_SIG_IN_OFFSET_START      bit(4)
#define LC_EVT_SIG_IN_OFFSET_ERROR      bit(5)
#define LC_EVT_SIG_IN_OFFSET_INIT       bit(6)

#define N_SIG_OUT_PIN 4
#define LC_EVT_SIG_OUT_INDEX_AS_READY     bit(0)
#define LC_EVT_SIG_OUT_INDEX_INJECT       bit(1)
#define LC_EVT_SIG_OUT_INDEX_GRAD_START   bit(2)
#define LC_EVT_SIG_OUT_INDEX_PUMP_STOP    bit(3)
...
extern volatile uint8_t sys_rt_exec_report; // Global realtime executor bitflag variable for spindle/coolant overrides.
