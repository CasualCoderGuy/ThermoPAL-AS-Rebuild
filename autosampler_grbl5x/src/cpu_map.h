...
#define cpu_map_h
  ...
  #if defined(DEBUGGER) || defined(SER_COMM_2)
  ...
  #define LC_EVT_SIG_IN_BIT_START   5  // Pin A13 - RAMPS T0 Port
  #define LC_EVT_SIG_IN_BIT_ERROR   6  // Pin A14 - RAMPS T1 Port
  #define LC_EVT_SIG_IN_BIT_INIT    7  // Pin A15 - RAMPS T2 Port
  #define LC_EVT_SIG_IN_MASK       ((1<<LC_EVT_SIG_IN_BIT_START)|(1<<LC_EVT_SIG_IN_BIT_ERROR)|(1<<LC_EVT_SIG_IN_BIT_INIT))
  ...
  #define PROBE_BIT       5  // MEGA2560 D32
  ...
  // Advanced Configuration Below You should not need to touch these variables
    ...
    #define FC_VALVE_DDR   DDRH
    #define FC_VALVE_PORT  PORTH
    #define FC_VALVE_BIT   3 // MEGA2560 Digital Pin 6
    ...
    #define FC_VALVE_DDR   DDRH
    #define FC_VALVE_PORT  PORTH
    #define FC_VALVE_BIT   5 // MEGA2560 Digital Pin 8

  #else
    #error "You must define SPINDLE_PWM_ON_D8 or SPINDLE_PWM_ON_D6 in config.h"
  #endif

  #define LC_EVT_SIG_OUT_DDR              DDRL
  #define LC_EVT_SIG_OUT_PORT             PORTL
  #define LC_EVT_SIG_OUT_BIT_AS_READY     1     // MEGA2560 Digital Pin 23
  #define LC_EVT_SIG_OUT_BIT_INJECT       3     // MEGA2560 Digital Pin 25
  #define LC_EVT_SIG_OUT_BIT_GRAD_START   5     // MEGA2560 Digital Pin 27
  #define LC_EVT_SIG_OUT_BIT_PUMP_STOP    7     // MEGA2560 Digital Pin 29
  #define LC_EVT_SIG_OUT_MASK             ((1<<LC_EVT_SIG_OUT_BIT_AS_READY)|(1<<LC_EVT_SIG_OUT_BIT_INJECT)|(1<<LC_EVT_SIG_OUT_BIT_GRAD_START)|(1<<LC_EVT_SIG_OUT_BIT_PUMP_STOP))

  #define SOFTWARE_RESET_DDR        DDRL
  #define SOFTWARE_RESET_PORT       PORTL
  #define SOFTWARE_RESET_BIT        0     // MEGA2560 Digital Pin 49
