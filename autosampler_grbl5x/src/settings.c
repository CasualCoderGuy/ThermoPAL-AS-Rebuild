...
const __flash settings_t defaults = {
    .disable_reset = DEFAULT_DISABLE_RESET,
    .sig_out_invert_mask = DEFAULT_SIG_OUT_INVERT_MASK,
    .sig_in_invert_mask = DEFAULT_SIG_IN_INVERT_MASK,
    .limit_invert_mask = DEFAULT_LIMIT_INVERT_MASK,
    ...
    .ratio[AXIS_1] = (DEFAULT_AXIS1_RATIO),
    .ratio[AXIS_2] = (DEFAULT_AXIS2_RATIO),
    .ratio[AXIS_3] = (DEFAULT_AXIS3_RATIO),
#if N_AXIS > 3
    ...
    .ratio[AXIS_4] = (DEFAULT_AXIS4_RATIO),
#endif
#if N_AXIS > 4
  ...
  if (parameter >= AXIS_SETTINGS_START_VAL) {
    ...
    while (set_idx < AXIS_N_SETTINGS) {
      if (parameter < N_AXIS) {
        ...
        switch (set_idx) {
          ...
          case 4: if (value > 1.0) { return(STATUS_SETTING_OUT_OF_RANGE); } settings.ratio[parameter] = value; break;
        }
    ...
    switch(parameter) {
      ...
      case 32:
        ...
        break;
      case 35: settings.disable_reset = value; break; //update
      case 40: settings.sig_out_invert_mask = value; break;
      case 41: settings.sig_in_invert_mask = value; break;
      case 42: settings.limit_invert_mask = value; break;
      default:
