...
#define CMD_RESET '@' // (was 0x18)
#define CMD_STATUS_REPORT '?'
#define CMD_CYCLE_START '~'
#define CMD_FEED_HOLD '!'
#define CMD_JOG_CANCEL  '^'
#define CMD_FC_VALVE_COLLECT 0x27 // '
#define CMD_FC_VALVE_WASTE 0x22   // "
...
#define CMD_SERIAL_WELCOME 0x85
...
// NOTE: Defaults are set for a traditional 3-axis CNC machine. Z-axis first to clear, followed by X & Y.
  ...
  #define HOMING_CYCLE_2 (1<<AXIS_1) // Home X axis  // OPTIONAL: uncomment to move only X at a time.
...
#define HOMING_AXIS_SEARCH_SCALAR  1.2 // Uncomment to override defaults in limits.c.
