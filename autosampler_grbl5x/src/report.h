...
#define STATUS_GCODE_COORDINATES_OUT_OF_RANGE 50
#define STATUS_GCODE_COMPONENT_OUT_OF_RANGE 51
#define STATUS_SETTING_OUT_OF_RANGE 52
#define STATUS_REQUESTED_COMPONENT_TYPE_NOT_INSTALLED 53
#define STATUS_OUT_OF_COLLECTION_VIALS 54
